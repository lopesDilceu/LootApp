      ...
      body: SingleChildScrollView( // Permite rolagem se o conteúdo for maior que a tela
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              // TODO: Adicionar seu logo ou um ícone representativo
              Icon(Icons.shield_moon_outlined, size: 80, color: Theme.of(context).primaryColor),
              ...
              TextFormField(
                ...
                autovalidateMode: AutovalidateMode.onUserInteraction, // Valida enquanto o usuário digita
              ),
